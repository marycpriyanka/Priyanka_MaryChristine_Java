...
public class GameStoreServiceLayerTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new GameStoreServiceLayer(invoiceRepository,
                taxRepository, processingFeeRepository, catalogApi);
    }
    ...
    private void setUpFeignClientMock() {
        catalogApi = mock(CatalogFeignClient.class);
        ...
        savedTShirt.setId(54);
        savedTShirt.setSize("Medium");
        savedTShirt.setColor("Blue");
        savedTShirt.setDescription("V-Neck");
        savedTShirt.setPrice(new BigDecimal("19.99"));
        savedTShirt.setQuantity(5);

        doReturn(savedTShirt).when(catalogApi).createTshirt(tShirt);
        doReturn(savedTShirt).when(catalogApi).findTshirtById(54);
    }
}